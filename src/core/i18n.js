...
const en = {
  ...
  'character.3': 'HEAVY', 'character.4': 'GHOST', 'character.5': 'VANGUARD X',
...
const es = {
  ...
  'character.3': 'PESADO', 'character.4': 'FANTASMA', 'character.5': 'VANGUARD X',
...
const ja = { ...en,
  ...
  'binding.forward':'前進','binding.back':'後退','binding.left':'左','binding.right':'右','binding.sprint':'走る','binding.evade':'カバー / 回避','binding.jump':'ジャンプ','binding.reload':'リロード','binding.swap':'武器切替','binding.score':'スコアボード','binding.aim':'照準','binding.fire':'射撃','binding.pause':'ポーズ','key.left':'左','key.right':'右','key.space':'スペース','key.arrow':'矢印','key.button':'ボタン','character.0':'新兵','character.1':'センチネル','character.2':'スカウト','character.3':'ヘビー','character.4':'ゴースト','character.5':'VANGUARD X','network.timeout':'接続がタイムアウトしました','network.failed':'接続できませんでした','network.closed':'接続が終了しました',
};
...
const zh = { ...en,
  ...
  'binding.forward':'前进','binding.back':'后退','binding.left':'左','binding.right':'右','binding.sprint':'奔跑','binding.evade':'掩体 / 闪避','binding.jump':'跳跃','binding.reload':'装填','binding.swap':'切换武器','binding.score':'记分板','binding.aim':'瞄准','binding.fire':'射击','binding.pause':'暂停','key.left':'左','key.right':'右','key.space':'空格','key.arrow':'方向键','key.button':'按钮','character.0':'新兵','character.1':'哨兵','character.2':'侦察兵','character.3':'重装兵','character.4':'幽灵','character.5':'VANGUARD X','network.timeout':'连接超时','network.failed':'无法连接','network.closed':'连接已关闭',
};
