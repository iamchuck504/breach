...
const states = [
  ...
  ['blind-low-left', P({ state: 'blind_low_left', firing: true }), 45],
  ['blind-low-right', P({ state: 'blind_low_right', firing: true }), 45],
  ['blind-high-left', P({ state: 'blind_high_left', firing: true }), 45],
  ['blind-high-right', P({ state: 'blind_high_right', firing: true }), 45],
