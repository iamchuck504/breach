...
check('flecha mueve divisor Jersey visible + collider como una unidad',
  ...
  // 46 sin enlace: topes del divisor, piezas medidas del carrito de café,
  // carteles de kiosco, las 2 cajas altas de la PARED URBANA (extremos
  // invisibles intencionales: 4) y el MOBILIARIO URBANO (parquímetros,
  // buzón, cabina, periódicos, botes y bancas — 14 cajas con sus espejos)
  proceduralMove.unlinkedBoxes === 46 && proceduralMove.intentionalInvisibleEnds === 4,
